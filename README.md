...
- 부가가치세 계산기 (일반과세 매출/매입)
- 종합소득세 계산기 (8단계 누진세율, 인적공제, 표준세액공제, 지방소득세)
- 원천세 계산기 (사업소득 3.3% / 기타소득 8.8% / 근로소득 간이세액 추정)
- 4대보험 계산기 (국민연금·건강·장기요양·고용·산재)
- 거래처(고객사) 목록 — DB 연동은 다음 단계
- 멀티테넌트 전환기 — 세무사용 / 고객사용 데모 토글
